...
const base: ProjectBase[] = [
  {
    ...
    accent: 'from-arc-blue/25 to-arc-cyan/10',
    ...
    repoUrl: 'https://github.com/arclight-studio/northwind-freight-platform',
  ...
  },
  {
    ...
    accent: 'from-arc-violet/25 to-arc-blue/10',
  ...
  },
  {
    ...
    accent: 'from-arc-cyan/20 to-arc-violet/10',
  ...
  },
  {
    ...
    accent: 'from-arc-cyan/25 to-arc-blue/10',
  ...
  },
  {
    ...
    accent: 'from-arc-violet/20 to-arc-cyan/10',
  ...
  },
  {
    ...
    accent: 'from-arc-blue/20 to-arc-violet/10',
  ...
  en: {
    ...
    'meridian-onboarding-automation': {
      ...
      caseStudy: {
        ...
        quote: {
          text: 'Arclight spent the first fortnight documenting how we actually work. The automation was almost a formality after that.',
  ...
  de: {
    ...
    'meridian-onboarding-automation': {
      ...
      caseStudy: {
        ...
        quote: {
          text: 'Arclight hat die ersten vierzehn Tage damit verbracht zu dokumentieren, wie wir tatsächlich arbeiten. Die Automatisierung war danach fast eine Formsache.',
  ...
  fr: {
    ...
    'meridian-onboarding-automation': {
      ...
      caseStudy: {
        ...
        quote: {
          text: 'Arclight a passé les quinze premiers jours à documenter notre façon réelle de travailler. L’automatisation n’a plus été qu’une formalité ensuite.',
