      ...
      <div className="container">
        <div className="relative isolate overflow-hidden rounded-2xl border border-border bg-card px-6 py-16 text-center md:px-16 md:py-20">
          ...
          <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
            <div className="absolute left-1/2 top-full h-[36rem] w-[min(90rem,140%)] -translate-x-1/2 -translate-y-1/2 rounded-[50%] border-t border-arc-violet/30 bg-[radial-gradient(closest-side,hsl(var(--arc-violet)/0.18),transparent_70%)]" />
          </div>
